      ...
      <div class="footer-grid">
        ...
        <nav class="footer-col" aria-label="Learn">
          ...
          <ul>
            ...
            ${isAppMode() ? "" : `<li><a href="downloads/ApexInnovators.apk" download data-app-download="true">${icon("smartphone")} Android App (APK)</a></li>`}
          </ul>
        </nav>
        <div class="footer-col">
          ...
          <div class="footer-cta">
            ...
            ${isAppMode() ? "" : `<a class="btn btn-outline btn-sm" href="downloads/ApexInnovators.apk" download data-app-download="true" style="color:#22d3ee;border-color:rgba(34,211,238,0.35);">${icon("download")} Download Android App</a>`}
          </div>
        </div>
      </div>
...
export function mountAuthUI() {
  ...
  const appBtn = isAppMode() ? "" : `<a class="btn btn-sm btn-outline" href="downloads/ApexInnovators.apk" download data-app-download="true" title="Download Android App" style="border-color:rgba(34,211,238,0.35);color:#22d3ee;display:inline-flex;align-items:center;gap:0.35rem;">${icon("smartphone")} <span>App</span></a>`;
